"""certifier_cc24cd - Structured data handler."""
...
def main():
    col = Collection()
    for i in range(5): col.add(Record(id=f"rec-{i}", tags=["auto"], metadata={"source": "certifier_cc24cd"}))
